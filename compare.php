        ...
        <div class="input">
          ...
          <div class="tip-container">
            ...
            <div class="btn-wrapper">
              <button class="btn tip" name="operator" value="comparision"> Compare </button>
            </div>
          </div>
        </div>
      </form>
              ...
              <div class="title">Result:
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                  if (isset( $_POST["firstNumber"] ) && isset( $_POST["secondNumber"] ) && isset( $_POST["operator"] )) {
                    ...
                    $result = ( $firstNumber > $secondNumber ? "$firstNumber is Bigger than $secondNumber" : "$secondNumber is bigger than $firstNumber " );
