        ...
        <div class="input">
          ...
          <div class="tip-container">
            ...
            <div class="btn-wrapper">
              <button class="btn tip" name="operator" value="Wheather"> Check </button>
        ...
        <div class="line-wrapper">
          <div class="line-output">
            <div class="title-wrapper">
              <div class="title">Wheather Update :  <?php
                if ($_SERVER["REQUEST_METHOD"]=="POST"){
                  if(isset($_POST["firstNumber"]) && isset($_POST["operator"])){
                    $temperature = $_POST["firstNumber"];
                    $operator = $_POST['operator'];
                    if ($temperature <= 0) {
                      echo "It's freezing!";
                  } elseif ($temperature > 0 && $temperature <= 15) {
                      echo "It's cool.";
                  } elseif ($temperature > 15 && $temperature <= 34) {
                      echo "It's warm.";
                  }else{
                    echo "It's Super warm.";
                  }
